...
const Icons = {
    ...
    archive: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><rect width="20" height="5" x="2" y="4" rx="2"/><path d="M4 9v9a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V9"/><path d="M10 13h4"/></svg>`,
    ...
    layers: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="m12.83 2.18a2 2 0 0 0-1.66 0L2.1 6.3a2 2 0 0 0 0 3.14l9.07 4.12a2 2 0 0 0 1.66 0l9.07-4.12a2 2 0 0 0 0-3.14z"/><path d="m2.1 11.41 9.07 4.13a2 2 0 0 0 1.66 0l9.07-4.13"/><path d="m2.1 16.53 9.07 4.13a2 2 0 0 0 1.66 0l9.07-4.13"/></svg>`,
    fingerprint: `<svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M12 10a2 2 0 0 0-2 2c0 1.02-.1 2.51-.26 4"/><path d="M15 13v-1.74a.8.8 0 0 1 1.09-.74c1.08.38 2.05 1 2.82 1.83"/><path d="M15 16.92v2.24"/><path d="M16.2 3.23a10 10 0 0 1 4.54 5.37"/><path d="M19.38 12c.07-.63.07-1.27 0-1.9"/><path d="M2.52 7a10 10 0 0 1 7.28-3.77"/><path d="M3.79 17.5a10 10 0 0 1-1.27-5.5"/><path d="M5 21a10 10 0 0 1-1.2-2.58"/><path d="M5.42 12.3c.09-1.28.45-2.52 1.06-3.64"/><path d="M8 17a4 4 0 0 1-2.92-2.61"/><path d="M8 9.24a4 4 0 0 1 7.6.22"/><path d="M9 19s-.04 1-.26 2"/></svg>`
};
